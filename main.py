...
def main():
    ...
    input_text = """/nix/store/z35z9arr-nixos-system-OrjanAMD-595.58.03-26.05pre977467.4c1018dae018.drv
...
/nix/store/z35zarr-nixos-system-Orjan_AMD-595.58.03-26.05pre977467.4c1018dae018.drv
└───/nix/store/dygnwmswkg1v839pnd3zg6b4431ggbg0-system-path.drv
