...
1. [ ] **Data Acquisition Layer**:
    *   [ ] Mock the nix commands so that the system can be tested on a non-nix environment.
...
3. [ ] **Persistence & Serving Layer**:
    *   [ ] **Storage**: SQLite database stores scan history and current vulnerability states.
...
1. [ ] **Initialize database**: Make sure the database is initialized upon startup of the service.
2. [ ] **Query the database**: Create SELECT-queries with JOINS to get timeseries.
...
1. [ ] The `nix derivation show` command is replaced by a mock module for development.
    ...
    *   *Reference*:
        ...
        ```
2. [ ] The `vulnix` scanner is replaced by a mock module for development.
    ...
    *   *Reference*: 
        ...
        ```
3. [ ] The `nix why-depends` command is replaced by a mock module for development.
